...
class StudentApp(tk.Tk):
    ...
    def delete_student_data(self):
      ...
      if MsgBox == 'yes':
          ...
          db_cursor.execute("use eskisi")  # Interact with Student Database
    ...
    def create_table(self):
        ...
        db_cursor.execute("CREATE DATABASE IF NOT EXISTS eskisi")  # Create a Database Named Student
        db_cursor.execute("use eskisi")  # Interact with Student Database
    ...
    def show_search_record(self):
        ...
        # Inserting record into student_master table of student database
        db_cursor.execute("use eskisi")  # Interact with Bank Database
